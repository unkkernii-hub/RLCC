...
local aa = {
    ...
    [52] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(155, 18, 28),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(15, 0, 0)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(196, 0, 0),
            Tab = Color3.fromRGB(10, 0, 0),
            Element = Color3.fromRGB(15, 0, 0),
            ElementBorder = Color3.fromRGB(170, 20, 30),
            InElementBorder = Color3.fromRGB(220, 40, 55),
            ElementTransparency = 0.9,
            ToggleSlider = Color3.fromRGB(196, 0, 0),
            ToggleToggled = Color3.fromRGB(196, 0, 0),
            SliderRail = Color3.fromRGB(196, 0, 0),
            DropdownFrame = Color3.fromRGB(196, 0, 0),
            DropdownHolder = Color3.fromRGB(0, 0, 0),
            DropdownBorder = Color3.fromRGB(196, 0, 0),
            DropdownOption = Color3.fromRGB(196, 0, 0),
